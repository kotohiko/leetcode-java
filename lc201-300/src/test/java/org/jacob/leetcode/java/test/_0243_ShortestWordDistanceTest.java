...
import org.jacob.leetcode.java.solution._0243_ShortestWordDistance_Solution;
...
public class _0243_ShortestWordDistanceTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while ((line = in.readLine()) != null) {
            ...
            var ret = new _0243_ShortestWordDistance_Solution().shortestDistance(wordsDict, word1, word2);
