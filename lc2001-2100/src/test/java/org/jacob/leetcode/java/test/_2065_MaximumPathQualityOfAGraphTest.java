...
import org.jacob.leetcode.java.solution._2065_MaximumPathQualityOfAGraph_Solution;
...
public class _2065_MaximumPathQualityOfAGraphTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while ((line = in.readLine()) != null) {
            ...
            var ret = new _2065_MaximumPathQualityOfAGraph_Solution().maximalPathQuality(values, edges, maxTime);
