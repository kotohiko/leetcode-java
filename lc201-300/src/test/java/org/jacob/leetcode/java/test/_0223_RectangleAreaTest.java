...
import org.jacob.leetcode.java.solution._0223_RectangleArea_Solution;
...
public class _0223_RectangleAreaTest {
    public static void main(String[] args) throws IOException {
        ...
        while ((line = in.readLine()) != null) {
            ...
            var ret = new _0223_RectangleArea_Solution().computeArea(ax1, ay1, ax2, ay2, bx1, by1, bx2, by2);
